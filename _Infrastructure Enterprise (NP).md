...
conf t
 ...
 router ospf 1
  router-id 32.0.0.1
  network 32.0.0.1 0.0.0.0 area 32
  network 10.32.32.0 0.0.0.255 area 32
...
conf t
 router ospf 1
  router-id 10.32.32.4
   network 10.32.0.0 0.0.255.255 area 32
 int gi 0/1
  ip ospf network point-to-point
  end
~~~
...
conf t
 router ospf 1
  ...
  network 10.32.100.0 0.0.0.255 area 32
  end
~~~
...
conf t
 ip access-list extended NAT-POLICY
  deny ip 10.32.0.0 0.0.255.255 10.11.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.12.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.21.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.22.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.31.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.32.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.41.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.42.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.51.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.52.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.61.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.62.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.71.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.72.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.81.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.82.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.91.0.0 0.0.255.255
  deny ip 10.32.0.0 0.0.255.255 10.92.0.0 0.0.255.255
  no deny ip 10.32.0.0 0.0.255.255 10.32.0.0 0.0.255.255
  permit ip any any
  end
~~~
...
!@CoreTAAS
config t
 hostname CoreTAAS-32-(PLDT)
 Track 1 Int gi 0/1 line-protocol
 int vlan 1
  standby 1 ip 10.32.1.16
  standby 1 preempt
...
conf t
 int tun1
  ip add 172.16.1.32 255.255.255.0
  ...
  no ip nhrp map 172.16.1.32 200.0.0.32
  end
~~~
...
conf t
 ...
 !
 no ip route 10.32.0.0 255.255.0.0 172.16.1.32 252
 end
~~~ 
