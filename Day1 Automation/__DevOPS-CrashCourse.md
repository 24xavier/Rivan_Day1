...
ifconfig ens256 10.32.1.6 netmask 255.255.255.0 up
~~~
...
ifname ens256 \
ipv4.method manual \
ipv4.addresses 10.32.1.6/24 \
autoconnect yes

nmcli connection up BRIDGED

ip route add 10.0.0.0/8 via 10.32.1.4 dev ens256
ip route add 200.0.0.0/24 via 10.32.1.4 dev ens256
...
route add 10.0.0.0/8 via 10.32.1.4
route add 200.0.0.0/24 via 10.32.1.4
~~~
...
~~~
[realdevices]
ctaas ansible_host=10.32.1.2 ansible_user=admin ansible_password=pass
cbaba ansible_host=10.32.1.4 ansible_user=rivan ansible_password=C1sc0123
...
~~~
[real_cisco]
CTAAS ansible_host=10.32.1.2
CBABA ansible_host=10.32.1.4
CUCM ansible_host=10.32.100.8
EDGE ansible_host=10.32.32.1
